...
exports.run = async (client, message, args) => {
  ...
  var durm = (Durum == "online" ? (`${client.emojis.cache.find(x => x.name === "thelox_online")} \`Çevrimiçi\``) : (Durum == "offline" ? (`${client.emojis.cache.find(x => x.name === "thelox_offline")} \`Çevrimdışı\``) : (Durum == "idle" ? (`${client.emojis.cache.find(x => x.name === "thelox_away")} \`Boşta\``) : (Durum == "dnd" ? (`${client.emojis.cache.find(x => x.name === "thelox_dnd")} \`Rahatsız Etmeyin\``) : ("Bilinmiyor/bulunamadı.")))));
